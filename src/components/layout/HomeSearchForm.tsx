      ...
      <Card className="p-6 md:p-8 shadow-2xl border-2 border-primary/20 max-w-4xl mx-auto bg-secondary">
        <form onSubmit={handleSubmit}>
          ...
          <p className="text-center text-sm text-muted-foreground mb-6">
            Pilih jenis mobil, lokasi, dan layanan yang Anda butuhkan
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <Select name="lokasi" onValueChange={setLokasi}>
              <SelectTrigger className="h-12 text-base" aria-label="Lokasi">
          ...
          <Button
            type="submit"
            size="lg"
            className="w-full h-14 text-xl font-bold bg-gradient-to-r from-primary to-blue-500 hover:scale-105 transition-transform duration-300 shadow-lg"
          >
