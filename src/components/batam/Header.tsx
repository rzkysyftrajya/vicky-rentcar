...
const whatsappLink ="https://wa.me/6282363389893?text=Halo%20vicky%20rentcar%20batam%2C%20saya%20ingin%20bertanya%20tentang%20rental%20mobil%20di%20Batam";

  const navigation = [
    { name: "Beranda", href: "/batam" },
    { name: "Armada", href: "/batam/fleet" },
    { name: "Layanan", href: "/batam/services" },
    { name: "Destinasi", href: "/batam/tourism" },
    { name: "Testimoni", href: "/batam/testimonials" },
    { name: "Kontak", href: "/batam/contact" },
  ];
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4" suppressHydrationWarning>
        ...
        >
          {/* Logo */}
          <Link href="/batam" className="flex items-center space-x-2">
          ...
          >
            ...
            >
              ...
              <span suppressHydrationWarning>Batam & Sekitanya</span>
            </div>
            <Button
              asChild
              variant="outline"
