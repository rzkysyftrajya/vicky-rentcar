// Vehicle types for service categorization - BATAM
...
export const batamCars: Car[] = [
  ...
  {
    name: "Alphard Gen 3",
    image: "/batam/armada/ALPHARD-GEN-3.webp",
    specs: ["7 Penumpang", "Matic", "Bensin"],
    category: "Luxury",
    serviceCategory: "VIP",
    highlights: [
  ...
  {
    name: "Land Cruiser",
    image: "/batam/armada/LAND-CRUISER.webp",
  ...
  },
  {
    ...
    image: "/batam/armada/FORTUNER-GR-4X2.webp",
    specs: ["7 Penumpang", "Matic", "Diesel"],
    category: "SUV",
    serviceCategory: "VIP",
    highlights: [
  ...
  },
  {
    ...
    image: "/batam/armada/FORTUNER-GR-4X4.webp",
    specs: ["7 Penumpang", "Matic", "Diesel"],
    category: "SUV",
    serviceCategory: "VIP",
    highlights: [
  ...
  {
    name: "Hiace Premio",
    image: "/batam/armada/HIACE-PREMIO.webp",
  ...
  {
    name: "Hiace Commuter",
    image: "/batam/armada/HIACE-COMMUTER.webp",
  ...
  },
  {
    ...
    image: "/batam/armada/ISUZU-ELF-MINIBUS.webp",
  ...
  // === SPECIAL PURPOSE VEHICLES ===
  {
    ...
    image: "/batam/armada/HILUX-DOUBLE-CABIN.webp",
  ...
  {
    name: "Toyota Rush",
    image: "/batam/armada/TOYOTA-RUSH.webp",
    specs: ["7 Penumpang", "Matic", "Bensin"],
    category: "SUV",
    serviceCategory: "Executive",
  ...
  {
    name: "Toyota Agya",
    image: "/batam/armada/TOYOTA-AGYA.webp",
  ...
  {
    name: "Daihatsu Ayla",
    image: "/batam/armada/DAIHATSU-AYLA.webp",
    specs: ["4 Penumpang", "Matic", "Irit BBM"],
    category: "City Car",
    serviceCategory: "Executive",
  ...
  {
    name: "Daihatsu Sigra",
    image: "/batam/armada/DAIHATSU-SIGRA.webp",
    specs: ["7 Penumpang", "Matic", "Bensin"],
    category: "MPV",
    serviceCategory: "Executive",
  ...
  },
  {
    ...
    image: "/batam/armada/DAIHATSU-TERIOS-DOUBLE-CABIN.webp",
    specs: ["7 Penumpang", "Matic", "Bensin"],
    category: "SUV",
    serviceCategory: "Special",
  ...
  {
    name: "Suzuki XL7",
    image: "/batam/armada/SUZUKI-XL7.webp",
    specs: ["7 Penumpang", "Matic", "Bensin"],
    category: "MPV",
    serviceCategory: "Executive",
  ...
  {
    name: "Xpander",
    image: "/batam/armada/XPANDER.webp",
    specs: ["7 Penumpang", "Matic", "Bensin"],
    category: "MPV",
    serviceCategory: "Executive",
    highlights: [
  ...
  {
    name: "Ertiga Hybrid",
    image: "/batam/armada/SUZUKI-ERTIGA-HYBRID.webp",
    specs: ["7 Penumpang", "Matic", "Hybrid"],
    category: "MPV",
    serviceCategory: "Executive",
    highlights: [
