...
export const metadata: Metadata = {
  title: "Armada - VRN Rent Car Surabaya | Sewa Mobil Terbaik di Jawa Timur",
  description: "Daftar armada mobil rental di Surabaya: Alphard, Fortuner, Innova, Hiace dan lainnya. Armada terawat dengan harga terbaik.",
};

export default function ArmadaPage() {
  const waLink = "https://wa.me/6282363389893?text=Halo%20Vicky%20Rentcar%20Surabaya,%20saya%20ingin%20memesan%20rental%20mobil";

  return (
    <main className={`${inter.className} min-h-screen bg-gradient-to-b from-blue-50 to-white overflow-x-hidden`}>
      
      {/* Hero Section */}
      <section className="relative py-24 bg-gradient-to-r from-blue-700 via-blue-800 to-blue-900 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {carOptions.map((car, index) => (
              <div key={index} className="bg-gray-50 rounded-2xl overflow-hidden hover:shadow-xl transition border border-gray-100 hover:border-blue-200 flex flex-col group">
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-gray-500 mb-3">{car.type} • {car.capacity}</p>
                  <div className="flex flex-wrap gap-2 mb-3 min-h-[2.5rem]">
                    {car.features.map((spec, i) => (
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li><a href="/surabaya/layanan" className="hover:text-white">Antar Jemput</a></li>
              </ul>
            </div>
            <div>
