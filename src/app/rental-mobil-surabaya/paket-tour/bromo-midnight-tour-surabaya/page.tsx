...
export default function BromoMidnightTourPage() {
  const whatsappNumber = "6282363389893";
  const whatsappMessage = encodeURIComponent(
    "Halo VRN, saya tertarik dengan Paket Bromo Midnight Tour dari Surabaya. Mohon info lengkap dan harga."
  );

  const itinerary = [
    "23.00 – Berangkat dari Surabaya/Malang",
    "02.00 – Tiba di area Bromo, briefing Jeep",
    "03.00 – Mulai pendakian Jeep menuju Penanjakan 1",
    "05.00 – Menyaksikan Sunrise Bromo yang spektakuler",
    "06.30 – Kaldera Bromo & Lautan Pasir",
    "08.00 – Bukit Teletubbies & Savanna",
    "10.00 – Sarapan di rest area",
    "12.00 – Kembali ke Surabaya",
    "17.00 – Tiba di Surabaya",
  ];

  const includes = [
    "Transportasi AC Surabaya-Bromo PP",
    "Jeep 4x4 resmi untuk sunrise & kaldera",
    "Tiket Bromo National Park",
    "Makan 1x breakfast + 1x lunch",
    "Air mineral & snack",
    "Driver/Guide berpengalaman",
    "Tol, parkir & entrance fee Jeep",
  ];
  ...
  return (
    <div className="flex flex-col bg-slate-50 min-h-screen">
      <section className="relative h-screen w-full overflow-hidden">
        <Image
          src="/tour-guide/gunung-bromo.webp"
          alt="Paket Bromo Midnight Tour Surabaya"
          fill
        ...
        <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-6 text-white">
          ...
          >
            Bromo Midnight Tour
            <span className="block text-2xl md:text-4xl lg:text-5xl text-orange-400 font-bold mt-4">dari Surabaya</span>
          </motion.h1>
          ...
          >
            Pengalaman sunrise Bromo paling spektakuler langsung dari Surabaya dalam 1 hari penuh petualangan.
          </motion.p>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-6 py-24 space-y-24">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <Image
                src="/tour-guide/gunung-bromo.webp"
                alt="Sunrise Bromo Midnight Tour"
                fill
          ...
          <div className="bg-white p-12 rounded-3xl shadow-xl border border-gray-100">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Fasilitas lengkap untuk pengalaman Bromo terbaik</p>
              </div>
            </div>
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 bg-gradient-to-r from-white to-orange-100 bg-clip-text text-transparent">
            Jangan Lewatkan Sunrise Bromo!
          </h2>
          
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto opacity-90 leading-relaxed">
            Pengalaman tak terlupakan melihat matahari terbit dari puncak gunung paling ikonik Indonesia.
          </p>
          ...
          >
            *Kuota terbatas! Booking sekarang dapat prioritas Jeep terbaik.
          </motion.p>
        </motion.section>
