...
export default function SurabayaMaduraTourPage() {
  ...
  const itinerary = [
    \"07.00 – Pick up dari hotel/airport Surabaya\",
    \"Melintasi Jembatan Suramadu (foto spot)\",
    \"Bukit Jaddih (kapur putih unik)\",
    \"Mercusuar Sembilangan (pemandangan laut)\",
    \"Pantai asmara & kuliner sate Madura\",
    \"Pasar karapan Sapi (budaya lokal)\",
    \"Wisata kuliner: Sate Madura & Rujak Soto\",
    \"16.00 – Kembali ke Surabaya\",
  ];

  const includes = [
    \"Transportasi AC full day\",
    \"Tol Suramadu PP\",
    \"Tiket masuk destinasi Madura\",
    \"Makan siang kuliner Madura\",
    \"Air mineral & snack\",
    \"Driver lokal yang paham Madura\",
    \"Parkir & retribusi\",
  ];

  const excludes = [
    \"Pengeluaran pribadi\",
    \"Biaya karapan sapi (jika ada event)\",
    \"Optional wisata tambahan\",
    \"Shopping oleh-oleh\",
  ];
    ...
    <div className=\"flex flex-col bg-slate-50 min-h-screen\">
      <section className=\"relative h-screen w-full overflow-hidden\">
        ...
        <div className=\"relative z-20 flex flex-col items-center justify-center h-full text-center px-6 text-white\">
          ...
          >
            Surabaya – Madura Tour
            <span className=\"block text-2xl md:text-4xl lg:text-5xl text-orange-400 font-bold mt-4\">Melintasi Suramadu</span>
          </motion.h1>
          ...
          >
            Jembatan terpanjang Indonesia + kuliner & budaya otentik Madura.
          </motion.p>
        </div>
      </section>
      ...
      <div className=\"max-w-6xl mx-auto px-6 py-24 space-y-24\">
          ...
          <div className=\"bg-white p-12 rounded-3xl shadow-xl border border-gray-100\">
            <div className=\"flex items-center gap-4 mb-8\">
              ...
              <div>
                ...
                <p className=\"text-gray-600 mt-1\">Fasilitas lengkap Madura tour</p>
              </div>
            </div>
          ...
          <div className=\"bg-white p-12 rounded-3xl shadow-xl border border-gray-100\">
            <div className=\"flex items-center gap-4 mb-8\">
              ...
              <div>
                ...
                <p className=\"text-gray-600 mt-1\">Biaya tambahan</p>
              </div>
            </div>
            <ul className=\"space-y-3\">
        ...
        >
          ...
          <p className=\"text-xl md:text-2xl mb-12 max-w-3xl mx-auto opacity-90 leading-relaxed\">
            Jembatan megah + budaya + kuliner Madura yang otentik dalam 1 hari seru.
          </p>
