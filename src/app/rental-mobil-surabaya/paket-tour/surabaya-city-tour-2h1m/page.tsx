...
export default function SurabayaCityTour2H1MPage() {
  const whatsappNumber = "6282363389893";
  const whatsappMessage = encodeURIComponent(
    "Halo VRN, saya tertarik dengan Paket Surabaya City Tour 2 Hari 1 Malam. Mohon info lengkap dan harga."
  );

  const itinerary = [
    "Hari 1: 07.00 – Meeting Point → Tugu Pahlawan → Monkasel → House of Sampoerna → Taman Bungkul → Pantai Kenjeran → Check-in Hotel",
    "Hari 2: 07.00 – Sarapan Hotel → Jembatan Suramadu → Kebun Binatang Surabaya → Ciputra Waterpark → Toko Oleh-Oleh → 17.00 Selesai",
  ];

  const includes = [
    "Transportasi AC selama 2 hari",
    "Hotel 1 malam (standar room)",
    "Tiket masuk objek wisata",
    "Makan 3x (2x lunch + 1x dinner)",
    "Air mineral & snack",
  ...
  const excludes = [
    "Pengeluaran pribadi",
    "Makan sarapan di hotel",
    "Biaya upgrade kamar hotel",
    "Optional activities",
  ];
    ...
    <div className="flex flex-col bg-slate-50 min-h-screen">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        <Image
          ...
          alt="Paket Surabaya City Tour 2 Hari 1 Malam"
          fill
        ...
        <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-6 text-white">
          ...
          >
            Jelajahi ikon-ikon kota Surabaya selama 2 hari penuh dengan akomodasi nyaman.
          </motion.p>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-6 py-24 space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <Image
                ...
                alt="Itinerary Surabaya City Tour 2H1M"
                fill
        ...
        >
          ...
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto opacity-90 leading-relaxed">
            Petualangan lengkap mengelilingi Surabaya dengan akomodasi nyaman dan fasilitas premium.
          </p>
