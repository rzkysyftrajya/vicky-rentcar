...
export default function SurabayaReligiTourPage() {
  const whatsappNumber = "6282363389893";
  const whatsappMessage = encodeURIComponent(
    "Halo VRN, saya tertarik dengan Paket Surabaya Religi Tour. Mohon info lengkap dan harga."
  );

  const itinerary = [
    "07.00 – Pick up dari hotel/airport",
    "Masjid Nasional Al-Akbar Surabaya (terbesar di Jatim)",
    "Kampung Arab & Makam Sunan Ampel",
    "Masjid Cheng Ho (arsitektur unik Cina-Islam)",
    "Klenteng Sanggar Ageng (Tionghoa kuno)",
    "Gereja Kelahiran Santa Maria (Katolik tertua Surabaya)",
    "Wisata kuliner halal + toko oleh-oleh",
    "17.00 – Drop off ke hotel/airport",
  ];

  const includes = [
    "Transportasi AC full day",
    "Tiket masuk semua destinasi religi",
    "Panduan lokal tentang sejarah religi Surabaya",
    "Makan siang halal",
    "Air mineral & snack",
    "Driver yang paham budaya lokal",
    "Tol & parkir",
  ];

  const excludes = [
    "Pengeluaran pribadi",
    "Sumbangan/sedekah di tempat ibadah",
    "Optional donation",
  ];
    ...
    <div className="flex flex-col bg-slate-50 min-h-screen">
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-6 text-white">
          ...
          >
            Surabaya Religi Tour
            <span className="block text-2xl md:text-4xl lg:text-5xl text-orange-400 font-bold mt-4">Harmoni 5 Agama</span>
          </motion.h1>
          ...
          >
            Kunjungi 6 tempat ibadah bersejarah dari 5 agama di kota paling toleran Indonesia.
          </motion.p>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-6 py-24 space-y-24">
          ...
          <div className="bg-white p-12 rounded-3xl shadow-xl border border-gray-100">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Fasilitas lengkap religi tour</p>
              </div>
            </div>
          ...
          <div className="bg-white p-12 rounded-3xl shadow-xl border border-gray-100">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Biaya tambahan pribadi</p>
              </div>
            </div>
            <ul className="space-y-3">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 bg-gradient-to-r from-white to-orange-100 bg-clip-text text-transparent">
            Nikmati Harmoni Religi Surabaya
          </h2>
          
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto opacity-90 leading-relaxed">
            Tour religi yang mendalam mengenal toleransi beragama di Kota Pahlawan.
          </p>
