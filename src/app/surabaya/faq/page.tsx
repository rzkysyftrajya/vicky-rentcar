...
const faqCategories = [
  {
    ...
    questions: [
      {
        q: "Apa itu VRN Rent Car Surabaya?",
        a: "VRN Rent Car Surabaya adalah perusahaan rental mobil terpercaya di Jawa Timur yang telah beroperasi sejak 2015. Kami menyediakan berbagai layanan rental mobil dengan armada terawat dan sopir profesional."
      },
      {
        q: "Apa keunggulan VRN Rent Car dibandingkan kompetitor?",
        a: "Keunggulan kami: (1) Armada terawat dengan service rutin, (2) Sopir profesional dan berpengalaman, (3) Harga transparan tanpa biaya tersembunyi, (4) Layanan 24/7, (5) Banyak pilihan tipe kendaraan, (6) Terpercaya sejak 2015 dengan ribuan pelanggan puas."
      },
      {
        q: "Apakah VRN Rent Car Surabaya resmi?",
    ...
    questions: [
      {
        ...
        a: "Kami menyediakan berbagai tipe mobil: (1) City Car: Agya, Calya, Brio, (2) MPV: Avanza, Ertiga, XPander, Innova, (3) SUV: Rush, Fortuner, Pajero, (4) Premium: Alphard, Camry, Hiace, (5) Minibus: Hiace Commuter, Elf."
      },
      {
      ...
      },
      {
        ...
        a: "Tentu! Kami menyediakan layanan antar jemput ke bandara Juanda 24/7. Harga sudah fix all-in termasuk tol dan parking."
      },
    ]
  },
  {
...
export default function FAQPage() {
  const waLink = "https://wa.me/6282363389893?text=Halo,%20saya%20ada%20pertanyaan%20tentang%20rental%20mobil%20di%20Surabaya";
        ...
        <div className="container mx-auto px-4 pt-20 text-center relative z-10">
          ...
          >
            ...
            <p className="text-blue-100 max-w-2xl mx-auto text-lg">
              Temukan jawaban untuk pertanyaan Anda tentang layanan rental mobil di Surabaya
            </p>
          </motion.div>
        </div>
      </section>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full bg-gray-50 rounded-xl p-6 text-left flex items-center justify-between hover:bg-blue-50 transition-colors"
                  >
                  ...
                  <AnimatePresence>
                    {openIndex === globalIndex && (
                      ...
                      >
                        <div className="bg-blue-50 rounded-b-xl p-6 -mt-2">
