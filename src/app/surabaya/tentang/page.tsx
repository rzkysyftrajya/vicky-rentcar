...
export const metadata: Metadata = {
  title: "Tentang Kami - VRN Rent Car Surabaya | Perusahaan Rental Mobil Terpercaya",
  description: "Kenali VRN Rent Car Surabaya lebih dekat. Perusahaan rental mobil terpercaya di Jawa Timur sejak 2015.",
};

const milestones = [
  { year: "2015", title: "Didirikan", description: "VRN Rent Car Surabaya mulai beroperasi", emoji: "🏙️" },
  { year: "2017", title: "Armada", description: "Menambah 30+ kendaraan baru", emoji: "🚗" },
  { year: "2019", title: "Sertifikasi", description: "Memperoleh sertifikasi resmi", emoji: "📜" },
  { year: "2021", title: "Digital", description: "Platform online diluncurkan", emoji: "📱" },
  { year: "2024", title: "Pelanggan", description: "1000+ pelanggan percaya", emoji: "⭐" },
];
  ...
  return (
    <main className={`${inter.className} min-h-screen bg-gradient-to-b from-blue-50 to-white`}>
      ...
      <section className="relative py-24 bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 overflow-hidden">
        ...
        <div className="container mx-auto px-4 pt-20 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            VRN Rent Car Surabaya
          </h1>
          <p className="text-blue-100 max-w-2xl mx-auto text-lg">
            Rental mobil terpercaya di Jawa Timur sejak 2015
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="bg-blue-100 text-blue-700 mb-4">🏙️ Siapa Kami?</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Mitra Perjalanan Anda di Surabaya
              </h2>
              <div className="space-y-4 text-gray-600 text-lg">
                <p>
                  <strong>VRN Rent Car Surabaya</strong> adalah perusahaan rental mobil terpercaya yang berlokasi di Jawa Timur. Kami telah beroperasi sejak tahun 2015 dengan komitmen memberikan layanan terbaik kepada setiap pelanggan.
                </p>
                <p>
                  Kami memahami bahwa perjalanan yang nyaman adalah kunci pengalaman yang menyenangkan. Dengan armada yang terawat dan sopir profesional, kami siap mengantar Anda mengeksplorasi keindahan kota Surabaya dan sekitarnya.
                </p>
                <p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="bg-blue-100 text-blue-700 mb-4">💎 KENAPA PILIH KAMI</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {whyChooseUs.map((item, index) => (
              <div 
                key={index}
                className="bg-gray-50 rounded-2xl p-6 text-center hover:bg-blue-50 transition"
              >
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><a href="/surabaya/layanan" className="hover:text-white">Rental Harian</a></li>
                <li><a href="/surabaya/layanan" className="hover:text-white">Rental Bulanan</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li><a href="/surabaya/kontak" className="hover:text-white">Kontak</a></li>
              </ul>
            </div>
            <div>
