      ...
      <main className="flex-1 bg-background text-foreground overflow-x-hidden">
        ...
        >
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
              Pilihan armada lengkap dan terawat siap menemani perjalanan Anda
        ...
        >
          <div className="container mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-gradient">
                Pelayanan Terbaik, Pengalaman Tak Terlupakan di Seluruh
                Indonesia
              </h2>
              <p className="mt-4 text-lg text-muted-foreground">
                Kami berkomitmen untuk memberikan pengalaman sewa mobil yang
                aman, nyaman, dan melebihi ekspektasi Anda di seluruh penjuru
                Nusantara.
              </p>
              ...
              <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
                <div className="mb-8 md:mb-0">
                  ...
                  <p className="mt-2 text-lg opacity-90 max-w-xl">
                    Jangan tunda lagi. Hubungi tim kami sekarang untuk
                    mendapatkan penawaran terbaik dan layanan rental mobil
